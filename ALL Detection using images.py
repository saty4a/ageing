...
# # Get the frontal face cascade classifier
...
# # Load the 3 detection models from your disk
...
# # Make a function that gonna do the face detection and then gonna make prediction according to the respective models loaded
...
# # Call the "detection" function and show the output 

# In[8]:


input_image = cv2.imread("I6.jpg")
