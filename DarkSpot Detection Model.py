...
DIRECTORY = r"dataset/Dark_Spots_Dataset"
CATEGORIES = ["Dark_Spots", "No_Spots"]
...
print("saving dark spot detector model.....")
model.save("darkSpot_detector.model",save_format="h5")
